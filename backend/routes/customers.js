...
router.get("/", authenticateToken, authorizeRole(['admin']), async (req, res) => {
  try {
    ...
    const customers = await User.find(query).select("name username email location address websiteUrl searchConsolePropertyUrl _id role facebookPageId facebookPageName instagramAccountId instagramAccountName instagramUsername facebookAccessToken facebookTokenExpiry facebookUserAccessToken facebookUserTokenExpiry bookingIntervalMonths googleAdsAccessToken googleAdsRefreshToken googleAdsTokenExpiry googleAdsCustomerId googleAdsAccountName googleAdsNeedsReauth googleBusinessProfileId googleBusinessProfileName googleBusinessAccountId googleBusinessAccountName googleBusinessLocationName googleBusinessAccessToken googleBusinessRefreshToken googleBusinessTokenExpiry googleBusinessNeedsReauth twilioPhoneNumber twilioForwardNumber twilioForwardNumberNew twilioForwardNumberExisting twilioMenuMessage twilioVoice aiReceptionistSettings");
