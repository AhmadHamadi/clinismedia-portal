...
const CustomerQuickBooksInvoicesPage: React.FC = () => {
      ...
      <div className="min-h-screen bg-gray-100 p-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-lg shadow-md p-8 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-2">QuickBooks Not Connected</h2>
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 sm:p-6 md:p-8 overflow-x-hidden">
      <div className="max-w-6xl xl:max-w-7xl 2xl:max-w-7xl mx-auto w-full">
        {/* Header */}
        <div className="mb-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">QuickBooks Invoices</h1>
        ...
        {/* Error Message */}
        {error && (
          <div className="mb-6 p-4 bg-red-50 border-l-4 border-red-400 text-red-800 rounded flex items-center justify-between">
            <div className="flex items-center">
