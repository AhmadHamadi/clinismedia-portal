...
const CustomerPortalLayout: React.FC<CustomerPortalLayoutProps> = ({ children, title, hideBackButton }) => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      <CustomerSidebar sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen} /> {/* Pass state and setter */}
