      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <div className="space-y-2 text-sm text-blue-800">
            ...
            <p>• <strong>Apply once, good forever:</strong> Each subject mapping is saved once. Every email that arrives at leads@clinimedia.ca with that subject is assigned to that clinic from then on—no need to re-apply.</p>
            <p>• <strong>Email Subjects:</strong> When emails arrive at leads@clinimedia.ca, the system matches the subject line to your mappings and assigns the lead to the correct clinic.</p>
